...
A global install also installs the `claude-skill-web-design` CLI on your PATH.
...
```bash
claude-skill-web-design install      # (re)copy SKILL.md into ~/.claude/skills/web-design
...
```bash
npx claude-skill-web-design uninstall
```
